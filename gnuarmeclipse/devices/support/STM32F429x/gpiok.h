...
#ifndef STM32_GPIOK_H_
#define STM32_GPIOK_H_
...
#define DEVICE_PATH_STM32_GPIOK DEVICE_PATH_STM32 "GPIOK"



// ----------------------------------------------------------------------------

#define TYPE_STM32_GPIOK TYPE_STM32_PREFIX "gpiok" TYPE_PERIPHERAL_SUFFIX

// ----------------------------------------------------------------------------

// Parent definitions.
#define TYPE_STM32_GPIOK_PARENT TYPE_PERIPHERAL
typedef PeripheralClass STM32GPIOKParentClass;
typedef PeripheralState STM32GPIOKParentState;

// ----------------------------------------------------------------------------

// Class definitions.
#define STM32_GPIOK_GET_CLASS(obj) \
    OBJECT_GET_CLASS(STM32GPIOKClass, (obj), TYPE_STM32_GPIOK)
#define STM32_GPIOK_CLASS(klass) \
    OBJECT_CLASS_CHECK(STM32GPIOKClass, (klass), TYPE_STM32_GPIOK)

typedef struct {
    // private: 
    STM32GPIOKParentClass parent_class;
    // public: 
...
#define STM32_GPIOK_STATE(obj) \
    OBJECT_CHECK(STM32GPIOKState, (obj), TYPE_STM32_GPIOK)

typedef struct {
    // private:
    STM32GPIOKParentState parent_obj;
    // public:
    ...
    union {
      ...
      struct {
        // F4 GPIOK (General-purpose I/Os) registers.
        struct { 
